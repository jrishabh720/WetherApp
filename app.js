...
const geocodeURL = `https://api.mapbox.com/geocoding/v5/mapbox.places/Los%20Angeles.json?access_token=${"pk.eyJ1IjoianJpc2hhYmg3MjAiLCJhIjoiY2s3MjVhaGdoMGQ4ZzNobXdpZXl4b3dmMSJ9.OgfzQJN79odC91Iw2eR4CQ"}&limit=1`;
request({url : geocodeURL , json : true},(error,response)=>{
	if(error){
		console.log("Error");
	}else if(!response.body.feature){
		console.log("Empty");
	}else{
